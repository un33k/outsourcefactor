...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobPost.contact'
        db.add_column('profiles_jobpost', 'contact',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=56, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'JobPost.contact'
        db.delete_column('profiles_jobpost', 'contact')
    ...
    models = {
        ...
        'profiles.jobpost': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 30, 0, 0)'}),
        ...
        'profiles.userprofile': {
            ...
            'availability_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 30, 0, 0)'}),
            'bookmarked': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
